...
function getRectangleString(width, height) {
  ...
  const str = firstLine + middleLines + lastLine;
  return str;
}
...
function encodeToRot13(str) {
  ...
  const alpfabet13 = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm';

  const str13 = str.split('').map((el) => alpfabet13[alphabet.indexOf(el)] || el).join('');
  return str13;
}
